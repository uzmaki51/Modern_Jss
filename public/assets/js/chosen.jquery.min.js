...
!function () {
    ...
    SelectParser = function () {
        ...
        }, AbstractChosen.default_multiple_text = "Select Some Options", AbstractChosen.default_single_text = "请选择", AbstractChosen.default_no_result_text = "No results match", AbstractChosen
        ...
        return d(Chosen, c), Chosen.prototype.setup = function () {
            ...
            if (this.is_multiple) {
                ...
                return b = a("<div />", {style: f}), b.text(this.search_field.val()), a("body").append(b), h = b.width() + 25, b.remove(), c = this.container.outerWidth(), h > c - 10 && (h = c - 10)
            }
        }, Chosen
    }(AbstractChosen)
}.call(this);