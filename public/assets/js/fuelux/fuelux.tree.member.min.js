(function (a, c) {
    var b = function (e, d) {
        ...
        this.$element.on("click", ".tree-item", a.proxy(function (f) {
            ...
            var childDiv = f.target.children;
            var selectedContent = childDiv[0].attributes;
            var memberId = selectedContent.value.nodeValue;
            var memberType = selectedContent.memberType.nodeValue;
            if(memberType == 1)
                location.href = '/business/companyMemberInfo?uid=' + memberId;
            else
                location.href = '/shipMember/registerShipMember?memberId=' + memberId;
                ...
                a.each(g.data, function (h, j) {
                    ...
                    if (j.type === "folder") {
                        ...
                        if (j.type === "item") {
                            ...
                            i.find(".tree-item-name").attr('item_id',j.value);
                            i.data(j);
