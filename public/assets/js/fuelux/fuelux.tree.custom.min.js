    ...
    var b = function (e, d) {
        ...
        this.$element.on("click", ".tree-item", a.proxy(function (f) {
            ...
            if(childDiv.length == 1) {
                ...
                selKindId = selectedContent.item_id.nodeValue;
            } else {
                var selectedContent = f.target.attributes;
                selKindId = selectedContent.item_id.nodeValue;
            }
            var selTitle = f.currentTarget.children[0].textContent;
            loadShipEquipmentData(selTitle, selKindId);
        }, this));
