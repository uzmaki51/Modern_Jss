(function (b) {
    b.toast = {};
    b.toast.options = {position: "", class_name: ""};
    b.toast.add = function (f) {
        try {
            return a.add(f || {})
        } catch (d) {
    ...
    b.toast.remove = function (d, c) {
        a.removeSpecific(d, c || {})
    };
    b.toast.removeAll = function (c) {
        a.stop(c || {})
    };
    var a = {
        position: "",
        ...
        add: function (g) {
            ...
            var k = g.title, n = g.text, e = g.image || "", l = g.sticky || false, m = g.class_name || b.toast.options.class_name, j = b.toast.options.position, d = g.time || "";
            this._verifyWrapper();
            this._item_count++;
        ...
        _runSetup: function () {
            for (opt in b.toast.options) {
                this[opt] = b.toast.options[opt]
            }
            this._is_setup = 1
        },
        stop: function (e) {
