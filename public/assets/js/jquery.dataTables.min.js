        ...
        var j = function (e) {
            ...
            this.oApi = {
                ...
                _fnCreateCookie: function (a, b, c, d, e) {
                    ...
                    var c = X.location.pathname.split("http://192.69.216.111/"), a = a + "_" + c.pop().replace(/[\/:]/g, "").toLowerCase(), g;
                    null !== e ? (g = "function" === typeof h.parseJSON ? h.parseJSON(b) : eval("(" + b + ")"),
                        b = e(a, g, f.toGMTString(), c.join("http://192.69.216.111/") + "/")) : b = a + "=" + encodeURIComponent(b) + "; expires=" + f.toGMTString() + "; path=" + c.join("http://192.69.216.111/") + "/";
                    a = l.cookie.split(";");
                    e = b.split(";")[0].length;
                    f = [];
                    if (4096 < e + l.cookie.length + 10) {
                        ...
                        for (f.sort(function (a, b) {
                            ...
                            d = f.pop();
                            l.cookie =
                                d.name + "=; expires=Thu, 01-Jan-1970 00:00:01 GMT; path=" + c.join("http://192.69.216.111/") + "/"
                        }
                    }
                    l.cookie = b
                },
                _fnReadCookie: function (a) {
                    for (var b = X.location.pathname.split("http://192.69.216.111/"), a = a + "_" + b[b.length - 1].replace(/[\/:]/g, "").toLowerCase() + "=", b = l.cookie.split(";"), c = 0; c < b.length; c++) {
