...
<script>
    ...
    function initializeNon() {
        ...
        nonInputObj = new Vue({
            ...
            methods: {
                onEditFinish: function() {
                    ...
                    nonContractObj.net_profit_day = this.output['net_profit_day'];
        ...
        nonInputObj.output['max_profit'] = __parseFloat('{!! $maxFreight !!}');
        nonInputObj.output['max_voy'] = __parseFloat('{!! $maxVoyNo !!}');
        nonInputObj.output['min_profit'] =   __parseFloat('{!! $minFreight !!}');
        nonInputObj.output['min_voy'] = __parseFloat('{!! $minVoyNo !!}');
