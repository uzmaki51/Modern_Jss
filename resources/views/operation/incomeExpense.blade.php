...
@section('content')
    ...
    <script>
        ...
        var graph_title = __parseStr($("#select-graph-ship option:selected").attr('data-name')) + ' ' + year_graph + '年 ';
        $('#graph-first-title').html(__parseStr(graph_title) + '利润&利润累计')
        $('#graph-second-title').html(__parseStr(graph_title) + '收支')
        $('#graph-third-title').html(__parseStr(graph_title) + '支出')
        initGraph();
