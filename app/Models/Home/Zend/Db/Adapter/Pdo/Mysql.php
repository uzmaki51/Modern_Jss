...
class Zend_Db_Adapter_Pdo_Mysql extends Zend_Db_Adapter_Pdo_Abstract
{
     ...
     * @return array
     */
    public function fetchRecords($tblName, $fields, $where='', $sortKey='', $sortOrder='ASC', $offset=0, $limit=0)
    {
        // building sql
        $sql = 'SELECT ';
        ...
        $sql .= $this->composeOrderBy($sortKey, $sortOrder);
        $sql .= $this->composeLimit($offset, $limit);
     ...
     * @return string
     */
    public function composeLimit($offset, $limit)
    {
     ...
     * @return string
     */
    public function composeOrderBy($sortKey, $sortOrder)
    {
        if (empty($sortKey)) {
            return '';
